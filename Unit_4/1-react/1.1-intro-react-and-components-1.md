...
<strong>False</strong>.  It may look like HTML, but it's a similar markup language known as JSX.
...
<p>There are the following React Elements (components):</p>
<ul>
  <li>A single `&lt;div&gt;` component</li>
  <li>A single `&lt;h1&gt;` component</li>
  <li>A single `&lt;ul&gt;` containing two `&lt;li&gt;` components</li>
</ul>
...
<strong>False</strong>.  They are named using <strong>UpperCamelCasing</strong>.
...
<strong>True</strong>. Only React Element components emit actual elements in the DOM.
